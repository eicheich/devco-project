<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 ">
            ...
            <div class="card w-100 bg-base-100 shadow-xl my-14 ">
                <div class="card-body">
